  ...
  return (
    <main className="shell" style={{ paddingBlock: 32 }}>
      ...
      <div className="ceiling-note" style={{ marginTop: 16, maxWidth: '65ch' }}>
        <strong>ธง &ldquo;เข้าตีเอง&rdquo; มาจากไหน:</strong> จากข้อมูลไฟล์เกม ไม่ใช่จากการไปยืนทดสอบ ·
        ...
        &ldquo;ไม่เข้าตีเอง&rdquo; ทั้งคู่ ซึ่งคนที่เคยเล่น RO ภาคอื่นจะแปลกใจ ·
