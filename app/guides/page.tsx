...
const GUIDES = [
  ...
  {
    href: '/guides/elemental-weapons',
    title: 'วิธีทำอาวุธธาตุ Blacksmith',
    blurb: 'ต้องใช้สกิล วัตถุดิบ และหินธาตุอะไร พร้อมขั้นตอนตีอาวุธธาตุและปัจจัยที่ทำให้สำเร็จง่ายขึ้น',
  },
  {
  ...
  {
    href: '/guides/forging',
    title: 'ตีอาวุธเอง — สูตรทั้งหมด',
    blurb: 'อาวุธที่ Blacksmith ตีเองได้ทุกแบบ วัตถุดิบครบ และอะไรทำให้ตีติดบ่อยขึ้น',
  },
  {
