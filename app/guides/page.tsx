...
const GUIDES = [
  ...
  },
  {
    ...
    blurb: 'NPC ทั้ง 13 อาชีพอยู่แมพไหน พิกัดเท่าไร ก๊อป /navi ไปวางในแชตเดินไปได้เลย',
  },
  {
    href: '/guides/pets',
    title: 'สัตว์เลี้ยง — ตัวไหนให้อะไร',
    blurb: 'โบนัสสเตตัสของสัตว์เลี้ยงแต่ละตัวตอนสนิทระดับ 1 และ 2 ของที่ใช้จับ และไข่ดรอปจากมอนตัวไหน',
  },
  {
