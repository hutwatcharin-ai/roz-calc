  ...
  return (
    <div className="card" style={{ marginTop: 16 }}>
      ...
      <p className="ceiling-note" style={{ marginTop: 14 }}>
        นี่คือ<strong>ส่วนที่เข้าเป้า</strong> ไม่ใช่ดาเมจ · ATK ของอาวุธ, DEF ของเป้าหมาย, การ์ด
        และตัวคูณสกิล อยู่ระหว่างตัวเลขนี้กับเลขที่ขึ้นบนจอ เว็บนี้ไม่ได้ยืนยันสูตรดาเมจของ Zero
        จึงไม่คิดให้ถึงตรงนั้น · ตัวเลขสองตัวที่คูณกันมาจากคู่มือเกมทางการทั้งคู่
      </p>
    </div>
  );
}
