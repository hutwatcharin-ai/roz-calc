...
## 3.8 ฟีเจอร์ "หาจุด AFK ปลอดภัย" (เพิ่ม 26 ส.ค.)
...
ต้องรอ 3.7 เสร็จก่อน เพราะใช้ `is_aggressive`
...
**⚠️ ห้ามเอาขึ้นเว็บ** — ตัวเลขที่เอกสารระบุเองว่ายังขัดกัน: อัตราตีบวก (+1..+4 ติด 90% เท่ากันหมด vs ไล่ระดับ 90/80/60), ปาร์ตี้ช่วยเก็บเลเวลไหม, EXP ปาร์ตี้แชร์ทั้งแมพหรือเฉพาะคนใกล้
