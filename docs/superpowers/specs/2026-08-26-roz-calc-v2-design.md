...
- เพิ่มลิงก์ใน nav: ปัจจุบันมี 4 ลิงก์ (หาจุดตี/ค้นของดรอป/มอนสเตอร์/ไอเทม) จะเพิ่มเป็น ~8 → **ต้องจัดกลุ่ม** ไม่ใช่ต่อท้ายเรียงกันจนล้น: จัดเป็น "เครื่องมือ" (หาจุดตี, ค้นของดรอป, ธาตุ, แผนฟาร์ม) กับ "ฐานข้อมูล" (มอนสเตอร์, ไอเทม, การ์ด, อุปกรณ์, สกิล, แมพ)
