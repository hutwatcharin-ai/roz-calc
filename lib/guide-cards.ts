...
export const GUIDES = [
  ...
  {
    href: '/guides/monster-behaviour',
    title: 'นิสัยมอนสเตอร์',
    blurb: 'รุม ไวต่อเวท มองมุด ตีทีละ 1 ขยับไม่ได้ มินิบอส — แต่ละคำแปลว่าอะไร ทำยังไงกับมัน และตัวไหนเป็นแบบนั้นบ้าง',
  },
  {
    href: '/guides/star-gear',
    title: 'อาวุธและชุดติดดาว ★',
    blurb: 'ระบบยังไม่เปิด แต่ต้องเก็บของรอตั้งแต่ตอนนี้ · ของดรอป 1 ชิ้นแลกโทเคน 1 อัน อาวุธ ★ ใช้ 100 อัน · ครบทุกชิ้นว่าติดดาวแล้วได้อะไร',
  },
  {
    href: '/guides/codes',
    title: 'โค้ดรับของ',
