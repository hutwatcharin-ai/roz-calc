...
export const SIZE_TABLE: WeaponSizeRow[] = [
  ...
  { weapon: 'Dagger', label: 'มีด', small: 100, medium: 75, large: 50 },
  ...
  { weapon: 'Katar', label: 'กาต้า', small: 75, medium: 100, large: 75 },
  { weapon: 'One-Handed Staff', label: 'คทามือเดียว', small: 100, medium: 100, large: 100 },
  { weapon: 'Two-Handed Staff', label: 'คทาสองมือ', small: 100, medium: 100, large: 100 },
  ...
  { weapon: 'Fist', label: 'สนับมือ', small: 100, medium: 100, large: 75 },
  ...
  { weapon: 'Huuma Shuriken', label: 'ชูริเคนยักษ์', small: 75, medium: 75, large: 100 },
