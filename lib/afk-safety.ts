...
export const SKILL_RISK_WHY: Record<SkillRisk, string> = {
  summons: 'ลูกสมุนที่เรียกมาเป็นมอนคนละตัว เว็บนี้ยังไม่ได้ตรวจว่ามันเข้าตีเองหรือเปล่า',
  ...
  transforms: 'กลายเป็นมอนอีกตัวที่เว็บนี้ไม่ได้ตรวจว่าเข้าตีเองหรือเปล่า',
};
